...
*/
pessoa.nomeCompleto();//Olá! Meu nome é Déborah Monaco!
...
..... idadeAnos = 'anos';
..... }
... if( pessoa.camimhouQuantosMetros === 1 ){
...
// Agora, apresente-se ;)
pessoa.apresentacao();
/*Olá, eu sou a Déborah Monaco,tenho 36anos, 1.8, meu peso é 98kg e, só hoje, eu já caminhei 600 metros!*/
```
